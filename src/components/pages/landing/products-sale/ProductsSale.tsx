...
const ProductsSale = () => {
  ...
  // if (loading) {
  //   return (
  //     <Container className="w-full my-[60px] lg:mb-24 lg:px-9 animate-pulse">
  ...
  //             Završava za:
  //           </Paragraph>
  //           <SaleCountdown date="2023-08-01T00:00:00Z" />
  //         </div>
  //       </div>
  //       <Spinner />
  //     </Container>
